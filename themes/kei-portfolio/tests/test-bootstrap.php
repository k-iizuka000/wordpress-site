<?php
/**
 * Test-specific Bootstrap File without functions.php auto-loading
 * 
 * This bootstrap file loads the minimum necessary components
 * without triggering functions.php auto-loading from composer
 * 
...
// Load Composer vendor dependencies manually to avoid functions.php auto-loading
$vendorDir = dirname( __DIR__ ) . '/vendor';

// Load PHPUnit
require_once $vendorDir . '/phpunit/phpunit/src/Framework/TestCase.php';
require_once $vendorDir . '/phpunit/phpunit/src/Framework/Assert.php';

// Load Composer ClassLoader without triggering file autoloading
require_once $vendorDir . '/composer/ClassLoader.php';

$loader = new \Composer\Autoload\ClassLoader();

// Load autoload mappings
$autoloadPsr4 = require $vendorDir . '/composer/autoload_psr4.php';
$autoloadClassmap = require $vendorDir . '/composer/autoload_classmap.php';

$loader->addPsr4('', $autoloadPsr4);
$loader->addClassMap($autoloadClassmap);
$loader->register();
...
echo "Test-specific bootstrap completed (without auto-loading functions.php).\n";
